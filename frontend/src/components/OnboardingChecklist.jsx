            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className={`text-sm font-medium ${step.completed ? 'text-white/70 line-through' : 'text-white'}`}>
                    {step.title}
                  </h4>
                </div>
                {!step.completed && (
          ...
          >
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2">
                ...
                <h4 className={`font-semibold text-lg ${step.completed ? 'text-white/70 line-through' : 'text-white'}`}>
                  {step.title}
                </h4>
              </div>
            ...
            {!step.completed && (
              <svg className="w-5 h-5 text-white/50 flex-shrink-0 mt-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
